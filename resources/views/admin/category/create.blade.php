                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-8">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h2 class="h4"><i class="bi bi-patch-check me-2"></i>Create New Category</h2>
                                        ...
                                        <form action="{{ route('categories.store') }}" method="POST"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control form-control-lg slug-source"
                                                    id="name" name="name"
                                                    placeholder="Enter the official name of the category." required
                                                    value="{{ old('name') }}">
                                                @error('name')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control slug-target" id="slug"
                                                        name="slug" placeholder="Enter the slug of the category."
                                            ...
                                            <div class="mb-4">
                                                <label for="brandLogo" class="form-label fw-bold">Category Logo /
                                                    Image</label>
                                            ...
                                            <div class="d-flex justify-content-end gap-2">
                                                ...
                                                <button type="submit" class="btn btn-success px-5">
                                                    <i class="bi bi-cloud-upload me-2"></i>Save Category
                                                </button>
                                            </div>
